// app/exercises/deadlift/page.tsx - Pagina Stacco da Terra con Header unificato
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Page Title */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Stacco da Terra Training con AI</h1>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h2 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                  <InformationCircleIcon className="w-5 h-5 mr-2 text-orange-600" />
                ...
                <ol className="space-y-3 text-sm text-gray-700">
                  ...
                  <li className="flex items-start">
                    <span className="font-semibold text-orange-600 mr-2">5.</span>
                    <span>Estendi contemporaneamente anche e ginocchia</span>
                  </li>
                  <li className="flex items-start">
                    <span className="font-semibold text-orange-600 mr-2">6.</span>
                    <span>Blocca in alto con spalle indietro</span>
                  </li>
                  <li className="flex items-start">
                    <span className="font-semibold text-orange-600 mr-2">7.</span>
