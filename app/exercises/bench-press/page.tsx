// app/exercises/bench-press/page.tsx - Pagina Panca Piana con Header unificato
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Page Title */}
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-900">Panca Piana Training con AI</h1>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <ol className="space-y-3 text-sm text-gray-700">
                  ...
                  <li className="flex items-start">
                    <span className="font-semibold text-green-600 mr-2">5.</span>
                    <span>Spingi esplosivamente verso l'alto</span>
                  </li>
                  <li className="flex items-start">
                    <span className="font-semibold text-green-600 mr-2">6.</span>
